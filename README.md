...
This blind replication package accompanies `Integrating and Testing the Literature: A Conceptual Replication of Continuous Integration Pain Points`, submitted to FSE 2019.
